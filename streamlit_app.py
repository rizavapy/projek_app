...
st.markdown("""
    ...
    .stApp {
        background-image: url('https://images.unsplash.com/photo-1651132138763-a53ccf34a879?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDN8fHxlbnwwfHx8fHw%3D');
