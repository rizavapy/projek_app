...
st.markdown("""
    ...
    .stApp {
        background-image: url('https://images.unsplash.com/photo-1660652023138-d464d95b97a0?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDU3fHx8ZW58MHx8fHx8');
